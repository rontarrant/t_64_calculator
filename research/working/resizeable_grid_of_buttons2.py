...
class ResizableButton(QPushButton):
    def __init__(self, text):
        ...
        self.setFont(QFont("Arial", 10))  # Set a default font

    def resizeEvent(self, event):
        super().resizeEvent(event)
        # Dynamically adjust font size based on button dimensions
...
class GridWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Resizable Grid Layout with Dynamic Font")
