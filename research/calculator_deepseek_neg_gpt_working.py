...
class CalculatorGUI(QMainWindow):
    ...
    def _create_mode_controls(self):
        ...
        toggle_sign_data = ("±", 6, 0, 'toggle_sign')
        btn = QPushButton(toggle_sign_data[0])
    ...
    def _create_buttons(self):
        ...
        buttons_data = [
            ("CLR", 0, 0, 'clear'), ("<<", 0, 1, 'one_op'), (">>", 0, 2, 'one_op'), ("NOT", 0, 3, 'one_op'),
    ...
    def _handle_toggle_sign(self):
        self.calculator_logic.press_toggle_sign()
        self._update_displays()
