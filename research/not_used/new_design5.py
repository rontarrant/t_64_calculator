...
class BaseConverter(QWidget):
    def __init__(self):
        ...
        mode_layout.addWidget(self.clear_button) # Add the clear button to the mode layout
    ...
    def clear_all(self):
        ...
        # Optionally uncheck the mode buttons
        self.hex_mode_button.setChecked(False)
        self.dec_mode_button.setChecked(False)
        self.bin_mode_button.setChecked(False)
        self.current_input_mode = None
        # Optionally set focus to one of the input fields or clear focus
        self.dec_input.setFocus() # Example: set focus to decimal after clear
