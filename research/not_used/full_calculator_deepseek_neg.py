        ...
        if digit == "+/-" or digit == "-":
            if current_display_str == "0":
                if self.signed_mode:
                    ...
                    return
            elif "-" in current_display_str:
                new_num_str = current_display_str.lstrip("-")
            else:
                if self.signed_mode:
                    new_num_str = "-" + current_display_str
                else:
                    return
        else:
