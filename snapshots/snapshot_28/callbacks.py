...
def register_labels(first_input, second_input, operation_label, results_output):
	...
	print("first_input:\n", first_input, "\n", first_input_label)
	print("second_input:\n", second_input, "\n", second_input_label)
	print("operation_label:\n", operation_label, "\n", operation_symbol_label)
	print("results_output:\n", results_output, "\n", results_output_label)
	print("current_label:\n", current_label)
	'''
...
def do_two_number_operation(flag):
	global current_label
	global second_input_label

	print("Doing two-number operation: ", flag)

	# show the math/logic symbol in the UI
	operation_symbol_label.setText(flag)
