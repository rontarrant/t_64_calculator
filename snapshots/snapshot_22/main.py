...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.first_input = AnalogLineEdit(lineedit_properties)
		self.math_label = QLabel()
		self.second_input = AnalogLineEdit(lineedit_properties)
		self.equals_label = QLabel("=")
		self.result_widget = AnalogLineEdit(lineedit_properties)
		...
		# *** ADD THIS LINE ***
      # Set a reasonable initial size for the window to help the layout
	...
	def _create_button_grid(self, start_row = 0):
		...
		total_rows = start_row + 10  # 3 input rows + 10 button rows
