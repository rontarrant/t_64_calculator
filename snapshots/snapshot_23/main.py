...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.button_layout.setColumnStretch(0, 1) # Give column 0 some stretch
		self.button_layout.setColumnStretch(1, 1) # Give column 1 some stretch
		self.button_layout.setColumnStretch(2, 1) # Give column 2 some stretch
		self.button_layout.setColumnStretch(3, 0) # Column with the QLabel, no extra stretch

		# Create input widgets
		self.first_input = LineEditColourLabel(lineedit_properties)
		self.first_input.setMinimumWidth(lineedit_properties["width"])
		self.math_label = QLabel()
		self.second_input = LineEditColourLabel(lineedit_properties)
		self.equals_label = QLabel("=")
		self.result_widget = LineEditColourLabel(lineedit_properties)
		...
		# Set styles
		self.first_input.setStyleSheet(input_style_sheet)
		self.second_input.setStyleSheet(input_style_sheet)
		self.result_widget.setStyleSheet(input_style_sheet)
	...
	def _create_input_area(self):
		...
		self.button_layout.addWidget(self.math_label, 0, 3)
		...
		self.result_widget.setSizePolicy(size_policy)
		self.button_layout.addWidget(self.result_widget, 2, 0, 1, 3)
		self.button_layout.addWidget(self.dummy_widget, 2, 3)
		'''
		# Set expanding size policies
		for widget in [self.first_input, self.math_label, 
							self.second_input, self.equals_label,
							self.result_widget, self.dummy_widget]:
