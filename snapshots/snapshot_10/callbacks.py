...
def handle_digit_click(main_window):
	clicked_button = main_window.sender()
	button_label = clicked_button.properties.get("label")
	print("\tInserting 0... main_window: ", main_window, ", button: ", button_label)

def insert_0(main_window):
	print("\tInserting 0... main_window: ", main_window)

def insert_1(main_window):
	print("\tInserting 1... main_window: ", main_window)

def insert_2(main_window):
	print("\tInserting 2... main_window: ", main_window)

def insert_3(main_window):
	print("\tInserting 3... main_window: ", main_window)

def insert_4(main_window):
	print("\tInserting 4... main_window: ", main_window)

def insert_5(main_window):
	print("\tInserting 5... main_window: ", main_window)
