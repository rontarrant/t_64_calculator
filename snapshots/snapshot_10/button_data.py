...
'''
NOTE:
The following test is only for laying out the buttons,
not for demonstrating how the buttons work.
The file callbacks.py contains all the callbacks
used for both this test and for the actual application
(see main.py) and because of changes made to how the
mutually-exclusive buttons work in main.py, this test
no longer shows proper workings of these buttons.
And, since the main app works, I can't be bothered to get
this test working properly again. So there.
'''
