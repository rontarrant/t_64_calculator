...
class MainWindow(QMainWindow):
	...
	def set_initial_size(self):
		...
		initial_width = num_button_cols * button_width + (num_button_cols - 1) * spacing + 20 # Add some extra margin
		initial_height = (3 * input_height) + (num_button_rows * button_height) + (num_button_rows - 1 + 2) * spacing + 40 # Add some extra margin
