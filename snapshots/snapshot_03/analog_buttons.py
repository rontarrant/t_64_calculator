...
class AnalogButton(QPushButton):
	...
	def paintEvent(self, event):
		...
		top_color = self.properties.get("top_color", QColor("#FFFFFF"))
		outline_color = self.properties.get("outline_color", QColor("#000000"))
		shadow_color = self.properties.get("shadow_color", QColor(0, 0, 0, 50))
		outline_width = self.properties.get("outline_width", 4)
